    ...
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12">
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          <p>
            Welcome to Dockit, your trusted partner in managing your healthcare
            needs conveniently and efficiently. At Dockit, we understand the
            challenges individuals face when it comes to scheduling doctor
            appointments and managing their health records.
          </p>
          <p>
            Dockit is committed to excellence in healthcare technology. We
            continuously strive to enhance our platform, integrating the latest
            advancements to improve user experience and deliver superior
            service. Whether you're booking your first appointment or managing
            ongoing care, Dockit is here to support you every step of the way.
          </p>
          <p className="text-gray-800">Our Vision</p>
          <p>
            Our vision at Dockit is to create a seamless healthcare experience
